...
<div class="c-Title u-FlexBox u-FlexBox--middle u-FlexBox--justify">
  ...
  <div class="c-Title__actions u-FlexBox u-FlexBox--middle u-FlexBox--justify u-FlexBox__item--fill">
    <router-link to="/edit" exact-active-class="is-active" class="c-Button">編集<arrow-right theme="filled"/></router-link>
    <router-link to="/report" exact-active-class="is-active" class="c-Button">キャンペーンレポート<chart-line theme="filled"/></router-link>
